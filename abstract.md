...
Архитектура представляет собой способ разбиения приложения на несколько слоёв. Самый распространённый вариант - presentation layer, business layer, data access layer. При необходимости слоём может быть больше. Такая архитектура подойт когда есть непоределенность, например при стартапе. Есть преимущества, что можно:
